...
const ImageCarousel: React.FC = () => {
  ...
  const handleImageError = (e: React.SyntheticEvent<HTMLImageElement, Event>) => {
    ...
    target.src = `https://picsum.photos/600/400?random=${Math.floor(Math.random() * 100)}`;
    target.onerror = null;
  };
    ...
    <section className="py-20 bg-stone-50 overflow-hidden border-t border-stone-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <div>
            <h2 className="text-base text-amber-600 font-semibold tracking-wide uppercase">现场实拍</h2>
