    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div>
            <h2 className="text-base text-amber-600 font-semibold tracking-wide uppercase">关于耀晟</h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">品质为本，诚信共赢</p>
            <div className="mt-4 text-lg text-gray-600 space-y-6">
              <p>威海耀晟木制品有限公司位于美丽的海滨城市——山东威海，是一家专注木制品加工，集研发、生产、销售、出口于一体的专业木制包装供应商。</p>
              <p>我们拥有一支经验丰富的技术工人团队，从原料甄选、切割组装到产品检验，每一道工序都由资深匠人严格把控，确保产品品质稳定。</p>
            </div>
            <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="flex flex-col items-center text-center p-4 bg-stone-50 rounded-lg">
                ...
                <p className="text-sm text-gray-500 mt-1">满足不同行业需求</p>
              </div>
              <div className="flex flex-col items-center text-center p-4 bg-stone-50 rounded-lg">
                <div className="p-3 bg-amber-100 rounded-full text-amber-700 mb-3">
                ...
                <p className="text-sm text-gray-500 mt-1">匠心工艺严格把控</p>
              </div>
              <div className="flex flex-col items-center text-center p-4 bg-stone-50 rounded-lg">
                <div className="p-3 bg-amber-100 rounded-full text-amber-700 mb-3">
